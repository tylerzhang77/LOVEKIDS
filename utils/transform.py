...
from .tools.bbox import _box_to_center_scale, _center_scale_to_box
from .tools.transforms import (addDPG, affine_transform, flip_joints_3d, flip_thetas, flip_xyz_joints_3d,
                          get_affine_transform, im_to_torch, batch_rodrigues_numpy, flip_twist,
                          rotate_xyz_jts, rot_aa, flip_cam_xyz_joints_3d)
from .tools.pose_utils import get_intrinsic_metrix
...
class CamTransform(object):
    ...
    def __init__(self, joint_pairs_17, joint_pairs_24, joint_pairs_29, bbox_shape, scale_factor, color_factor, occlusion, add_dpg,
        ...
        if two_d:
            ...
            self._joint_pairs_17 = joint_pairs_17
            self._joint_pairs_24 = joint_pairs_24
            self._joint_pairs_29 = joint_pairs_29
